...
Original ArrayBag from: Ken Lambert

This contains the LinkedBag class, which now holds a clone method.
"""
...
class LinkedBag(object):
    ...
    # Assignment: the clone method
    def clone(self):
        """ Returns an exact copy of the linked bag. """
        clone_bag = LinkedBag(self)
        return clone_bag
